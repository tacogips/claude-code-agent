 ...
 * ```
 */
export declare function expectOk<T, E>(result: Result<T, E>): T;
/**
 ...
 * ```
 */
export declare function expectErr<T, E>(result: Result<T, E>): E;
/**
 ...
 * ```
 */
export declare function expectResultValue<T, E>(result: Result<T, E>, assertions: (value: T) => void): void;
/**
 ...
 * ```
 */
export declare function expectResultError<T, E extends {
    code?: string;
    message?: string;
