 ...
 * ```
 */
export declare function runConcurrent<T>(operations: ReadonlyArray<() => Promise<T>>, options?: RunConcurrentOptions): Promise<ReadonlyArray<ConcurrentResult<T>>>;
/**
 ...
 * ```
 */
export declare function verifyNoLostUpdates<T>(initial: T, modifications: ReadonlyArray<(current: T) => T>, readFn: () => Promise<T>, writeFn: (value: T) => Promise<void>): Promise<VerifyNoLostUpdatesResult<T>>;
