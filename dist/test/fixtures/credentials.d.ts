 ...
 * ```
 */
export declare function createTestCredentials(overrides?: Partial<OAuthTokensInput>): OAuthTokensInput;
/**
 ...
 * ```
 */
export declare function createMockOAuthCredentials(overrides?: Partial<OAuthCredentialsResult>): OAuthCredentialsResult;
