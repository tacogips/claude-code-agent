 ...
 */
export type SessionState = "idle" | "starting" | "running" | "waiting_tool_call" | "waiting_permission" | "paused" | "completed" | "failed" | "cancelled";
/**
 ...
 * ```
 */
export declare function isValidSessionState(value: unknown): value is SessionState;
