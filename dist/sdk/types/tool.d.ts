 ...
 * ```
 */
export type SimpleInputSchema = Readonly<Record<string, "string" | "number" | "boolean" | "object" | "array">>;
/**
 ...
 * ```
 */
export declare function isJsonSchema(schema: ToolInputSchema): schema is JsonSchema;
/**
 ...
 * ```
 */
export declare function isSimpleSchema(schema: ToolInputSchema): schema is SimpleInputSchema;
/**
 ...
 * ```
 */
export declare function isToolResultContent(value: unknown): value is ToolResultContent;
/**
