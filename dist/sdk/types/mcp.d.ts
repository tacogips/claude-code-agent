 ...
 */
export type McpServerConfig = McpStdioServerConfig | McpHttpServerConfig | McpSdkServerConfig;
/**
 ...
 * ```
 */
export declare function isSdkServer(config: McpServerConfig): config is McpSdkServerConfig;
/**
 ...
 * ```
 */
export declare function isStdioServer(config: McpServerConfig): config is McpStdioServerConfig;
/**
 ...
 * ```
 */
export declare function isHttpServer(config: McpServerConfig): config is McpHttpServerConfig;
/**
 ...
 * ```
 */
export declare function isValidMcpServerConfig(config: unknown): config is McpServerConfig;
