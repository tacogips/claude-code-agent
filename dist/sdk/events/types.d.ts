...
import type { GroupCreatedEvent, GroupStartedEvent, GroupCompletedEvent, GroupPausedEvent, GroupResumedEvent, GroupFailedEvent, GroupSessionStartedEvent, GroupSessionCompletedEvent, GroupSessionFailedEvent, BudgetWarningEvent, BudgetExceededEvent, DependencyWaitingEvent, DependencyResolvedEvent, SessionProgressEvent, GroupProgressEvent, GroupEvent } from "../group/events";
export type { GroupCreatedEvent, GroupStartedEvent, GroupCompletedEvent, GroupPausedEvent, GroupResumedEvent, GroupFailedEvent, GroupSessionStartedEvent, GroupSessionCompletedEvent, GroupSessionFailedEvent, BudgetWarningEvent, BudgetExceededEvent, DependencyWaitingEvent, DependencyResolvedEvent, SessionProgressEvent, GroupProgressEvent, GroupEvent, };
import type { QueueEvent as QueueEventType } from "../queue/events";
/**
 * All session-related events.
 */
export type SessionEvent = SessionStartedEvent | SessionEndedEvent | MessageReceivedEvent | ToolStartedEvent | ToolCompletedEvent | TasksUpdatedEvent;
/**
...
export interface EventMap {
    ...
    queue_created: Extract<QueueEvent, {
        type: "queue_created";
    }>;
    queue_started: Extract<QueueEvent, {
        type: "queue_started";
    }>;
    queue_completed: Extract<QueueEvent, {
        type: "queue_completed";
    }>;
    queue_paused: Extract<QueueEvent, {
        type: "queue_paused";
    }>;
    queue_resumed: Extract<QueueEvent, {
        type: "queue_resumed";
    }>;
    queue_stopped: Extract<QueueEvent, {
        type: "queue_stopped";
    }>;
    queue_failed: Extract<QueueEvent, {
        type: "queue_failed";
    }>;
    command_started: Extract<QueueEvent, {
        type: "command_started";
    }>;
    command_completed: Extract<QueueEvent, {
        type: "command_completed";
    }>;
    command_failed: Extract<QueueEvent, {
        type: "command_failed";
    }>;
    command_added: Extract<QueueEvent, {
        type: "command_added";
    }>;
    command_updated: Extract<QueueEvent, {
        type: "command_updated";
    }>;
    command_removed: Extract<QueueEvent, {
        type: "command_removed";
    }>;
    command_reordered: Extract<QueueEvent, {
        type: "command_reordered";
    }>;
    command_mode_changed: Extract<QueueEvent, {
