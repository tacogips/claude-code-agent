 ...
 */
export type GroupStatus = "created" | "running" | "paused" | "completed" | "failed" | "archived" | "deleted";
/**
 ...
 */
export declare function isTerminalGroupStatus(status: GroupStatus): boolean;
/**
 * Check if a group can be resumed.
 */
export declare function canResumeGroup(status: GroupStatus): boolean;
/**
 * Check if a group is currently active.
 */
export declare function isActiveGroup(status: GroupStatus): boolean;
/**
 ...
 */
export declare const DEFAULT_GROUP_CONFIG: GroupConfig;
