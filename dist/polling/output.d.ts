 ...
 */
export type MonitorEvent = ToolStartEvent | ToolEndEvent | SubagentStartEvent | SubagentEndEvent | MessageEvent | TaskUpdateEvent | SessionEndEvent;
/**
 ...
 * ```
 */
export declare class JsonStreamOutput {
