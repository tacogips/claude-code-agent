 ...
 * ```
 */
export declare abstract class BaseFileRepository<T> {
     ...
     */
    constructor(fs: FileSystem, lockService: FileLockService, atomicWriter: AtomicWriter);
    /**
     ...
     */
    protected writeWithLock(filePath: string, data: T, options?: LockOptions): Promise<void>;
    /**
     ...
     * ```
     */
    protected modifyWithLock(filePath: string, modifier: (current: T | null) => T, options?: LockOptions): Promise<T>;
    /**
     ...
     */
    protected deleteWithLock(filePath: string, options?: LockOptions): Promise<boolean>;
}
