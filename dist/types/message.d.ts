 ...
 */
export declare function hasToolCalls(message: Message): message is Message & {
 ...
 */
export declare function hasToolResults(message: Message): message is Message & {
 ...
 */
export declare function isAssistantToolUseMessage(message: Message): message is Message & {
 ...
 */
export declare function isUserToolResultMessage(message: Message): message is Message & {
    readonly role: "user";
    readonly toolResults: readonly ToolResult[];
};
/**
 ...
 */
export declare function getMessageKind(message: Message): MessageKind;
/**
 ...
 */
export declare function isToolRelatedMessage(message: Message): boolean;
