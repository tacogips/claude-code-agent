 ...
 */
export declare function toSessionMetadata(session: Session): SessionMetadata;
/**
 ...
 */
export declare function canResume(status: SessionStatus): boolean;
/**
 ...
 */
export declare function isPending(status: SessionStatus): boolean;
