      ...
      async ({ body, set, token }) => {
        ...
        try {
          ...
          if (!req.name || !req.projectPath) {
            ...
            return {
              error: "Bad Request",
              message: "Missing required fields: name, projectPath",
            };
          }
    ...
    queues.post(
      ...
      async ({ params, set, token }) => {
        ...
        try {
          ...
          // Run queue using QueueRunner
          await sdk.queueRunner.run(queueId);
    ...
    queues.post(
      ...
      async ({ params, set, token }) => {
        ...
        try {
          ...
          // Resume queue using QueueRunner
          await sdk.queueRunner.resume();
