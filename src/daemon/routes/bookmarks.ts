    ...
    bookmarks.post(
      ...
      async ({ body, set, token }) => {
        ...
        if (!tokenManager.hasPermission(token, "bookmark:*")) {
          set.status = 403;
          return { error: "Forbidden", message: "Missing permission: bookmark:*" };
        }
        ...
        try {
          ...
          const bookmark = await sdk.bookmarks.createBookmark({
    ...
    bookmarks.get(
      ...
      async ({ query, set, token }) => {
        ...
        try {
          ...
          const result = await sdk.bookmarks.listBookmarks(filter);
    ...
    bookmarks.get(
      ...
      async ({ query, set, token }) => {
        ...
        try {
          ...
          // Search bookmarks
          const result = await sdk.bookmarks.searchBookmarks(params.q, {
    ...
    bookmarks.get(
      ...
      async ({ params, set, token }) => {
        ...
        try {
          ...
          const bookmark = await sdk.bookmarks.getBookmark(bookmarkId);

          if (!bookmark) {
            set.status = 404;
            return { error: "Not Found", message: `Bookmark not found: ${bookmarkId}` };
          }
    ...
    bookmarks.get(
      ...
      async ({ params, set, token }) => {
        ...
        try {
          ...
          const result = await sdk.bookmarks.getBookmarkWithContent(bookmarkId);
    ...
    bookmarks.delete(
      ...
      async ({ params, set, token }) => {
        ...
        try {
          ...
          // Delete bookmark
          await sdk.bookmarks.deleteBookmark(bookmarkId);
